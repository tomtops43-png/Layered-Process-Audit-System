...
SHEET_HEADERS[SHEET_NAMES.CHECKLIST] = ['ChecklistID', 'Category', 'CheckItem', 'StandardCriteria', 'ExampleOK', 'ExampleNG', 'LineID', 'LineName', 'StationID', 'StationName', 'AuditLayer', 'Frequency', 'Severity', 'RequirePhotoWhenNG', 'RequireActionWhenNG', 'ReferenceDocNo', 'Revision', 'EffectiveDate', 'ActiveStatus', 'SortOrder', 'CreatedAt', 'CreatedBy', 'UpdatedAt', 'UpdatedBy'];
