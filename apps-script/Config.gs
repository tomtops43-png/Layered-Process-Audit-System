...
SHEET_HEADERS[SHEET_NAMES.FINDINGS] = ['FindingID', 'AuditID', 'RecordID', 'FoundDate', 'PeriodMonth', 'LineID', 'LineName', 'StationID', 'StationName', 'Area', 'Category', 'ProblemDetail', 'StandardCriteria', 'CorrectiveAction', 'RootCause', 'RootCauseCategory', 'ActionRemark', 'AssignmentMode', 'AssignedRole', 'AssignedRoleName', 'AssignedUserID', 'AssignedUserName', 'ResponsibleUserID', 'ResponsiblePerson', 'Responsible', 'PICUserID', 'PICName', 'AuditorUserID', 'AuditorName', 'AuditorRole', 'AssignedToUserID', 'AssignedToName', 'AssignedToRole', 'VerifierUserID', 'VerifierName', 'VerifierRole', 'Severity', 'VerificationRequired', 'VerificationStatus', 'SubmittedAt', 'SubmittedBy', 'SubmittedByName', 'ActionBy', 'ActionByName', 'DueDate', 'Status', 'Priority', 'BeforePhotoURL', 'AfterPhotoURL', 'PhotoBeforeID', 'PhotoAfterID', 'ClosedDate', 'ClosedAt', 'ClosedBy', 'ClosedByName', 'CloseRemark', 'RejectedAt', 'RejectedBy', 'RejectedByName', 'RejectReason', 'OverdueFlag', 'DaysOverdue', 'CreatedAt', 'CreatedBy', 'UpdatedAt', 'UpdatedBy'];
...
SHEET_HEADERS[SHEET_NAMES.MEETING_POSTS] = ['PostID', 'MeetingDate', 'Shift', 'LineID', 'LineName', 'Category', 'Priority', 'Topic', 'Detail', 'PhotoURL', 'Status', 'Pinned', 'DiscussedAt', 'DiscussedBy', 'CreatedAt', 'CreatedBy', 'CreatedByName', 'UpdatedAt', 'UpdatedBy', 'AckRequiredUserIDs', 'AckRequiredNames', 'SlideFileURL', 'SlideFileName'];
