...
function getDefaultRolePermissions_() {
  return {
    ...
    Supervisor: ['audit.supervisor.create', 'audit.view.all', 'audit.plan.view', 'audit.plan.generate', 'findings.view.all', 'findings.assign', 'findings.update.line', 'findings.verify', 'findings.close.minor', 'findings.close.major', 'dashboard.view', 'reports.view'],
