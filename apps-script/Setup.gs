...
function getDefaultRolePermissions_() {
  return {
    ...
    Supervisor: ['audit.supervisor.create', 'audit.view.line', 'audit.plan.view', 'audit.plan.generate', 'findings.view.line', 'findings.assign', 'findings.update.line', 'findings.verify', 'findings.close.minor', 'findings.close.major', 'dashboard.view'],
