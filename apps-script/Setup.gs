...
function getDefaultRolePermissions_() {
  return {
    ...
    Manager: ['audit.manager.create', 'audit.view.all', 'audit.plan.view', 'audit.plan.manage', 'audit.plan.generate', 'audit.plan.refresh', 'findings.view.all', 'findings.assign', 'findings.verify', 'findings.close.minor', 'findings.close.major', 'findings.close.critical', 'dashboard.view.all', 'reports.view', 'reports.export', 'meeting.view', 'meeting.create', 'meeting.update.own', 'meeting.manage'],
    Supervisor: ['audit.supervisor.create', 'audit.view.all', 'audit.plan.view', 'audit.plan.generate', 'findings.view.all', 'findings.assign', 'findings.update.line', 'findings.verify', 'findings.close.minor', 'findings.close.major', 'dashboard.view', 'reports.view', 'meeting.view', 'meeting.create', 'meeting.update.own', 'meeting.manage'],
    Engineer: ['audit.engineer.create', 'audit.view.line', 'audit.plan.view', 'findings.view.line', 'findings.assign', 'findings.update.line', 'findings.verify', 'findings.close.minor', 'findings.close.major', 'dashboard.view', 'reports.view', 'meeting.view', 'meeting.create', 'meeting.update.own'],
